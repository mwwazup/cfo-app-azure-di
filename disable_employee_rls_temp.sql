...
-- Clerk deprecated JWT templates, so RLS policies can't extract user IDs from Clerk tokens
...
SELECT '⚠️ Remember: Security is handled by Clerk auth + app code filtering by user_id' AS note;
