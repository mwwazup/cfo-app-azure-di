          ...
          <div className="container px-4 md:px-6 max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div key={title} className="bg-[#fffaf4] rounded-lg p-6 shadow-sm border border-accent hover:shadow-md transition-shadow duration-200">
          ...
          <div className="container px-4 md:px-6 max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={title} className="bg-card rounded-lg p-6 shadow-sm border border-accent hover:shadow-md transition-shadow duration-200">
